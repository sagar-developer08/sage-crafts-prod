...
// export default function PortfolioDetailsArea({ project }: Props) {
//   const {
//     title,
//     imageUrl,
//     serviceLabel,
...
//             <div className="meta-item">
//               <p className="title">Service</p>
//               <p className="text">{serviceLabel || "-"}</p>
//             </div>
//             <div className="meta-item">
//               <p className="title">Client</p>
...
//             <div className="meta-item">
//               <p className="title">Date</p>
//               <p className="text">{detailDate || "-"}</p>
//             </div>
//             <div className="meta-item">
//               <p className="title">Technology</p>
//               <p className="text">{techText || "-"}</p>
//             </div>
//           </div>
//         </div>
...
//                 <p className="text">
//                   {overviewText ||
//                     "No overview text provided yet. Please update this project in the admin panel."}
//                 </p>
//               </div>
//               <div className="feature-list">
//                 <ul>
...
//                     text: "Visual hierarchy is the principle of arranging elements to show their order of importance. By laying out elements logically, designers guide the user through information in a clear and intuitive way.",
//                   },
//                   {
//                     title: "Components",
//                     text: "Components keep the system consistent and easier to maintain, making it simple to extend visuals to new contexts while staying on-brand.",
//                   },
//                 ]
//             ).map((sec, idx) => (
//               <div className="details-info" key={idx}>
//                 <h3 className="title">{sec.title}</h3>
