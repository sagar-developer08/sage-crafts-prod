        ...
        <div className="blog-area-inner section-spacing-top">
              ...
              <div className="title-wrapper">
                <h2 className="section-title font-sequelsans-romanbody rr_title_anim">
                  ...
                  <span className="mb-14">
                    <Link href="/blog" className="rr-btn-group">
                      <span className="b">Learn all news</span>
                      <span className="c">
          ...
          <div className="blogs-wrapper-box">
            <div className="blogs-wrapper">
              {blogDataOne.map((blog, idx) => (
                <Link href={`/blog-details/${blog.id}`} key={blog.title + idx}>
                  <article className="blog fade-anim" data-delay={blog.delay}>
                    <div className="thumb">
                      <Image src={blog.img} alt="blog image" width={410} height={290} style={{height:"auto"}} />
                    </div>
                    <div className="content-wrapper">
                      <div className="content">
                        ...
                        <div className="meta">
                          ...
                          <span className="date has-left-line">{blog.date}</span>
                        </div>
                      </div>
                    </div>
                  </article>
